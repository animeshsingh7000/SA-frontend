            ...
            <div className="common-right-panel-section">
                <div className="top-right-bar">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item href="#">Recent Departure</Breadcrumb.Item>
                    </Breadcrumb>
                ...
                <div className="mid-content-section">
                    <Tabs
                        defaultActiveKey="AllDeparture"
                        id="fill-tab-example"
                        className="mb-3"
                        fill
                    >
                        <Tab eventKey="AllDeparture" title="All Departure">
                                ...
                                <Table responsive className="">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><div className="th-data">Days <div className="sort-table"><img src={sortIcon} alt="sort" /></div></div></th>

                                            <th><div className="th-data">Arrival <div className="sort-table"><img src={sortIcon} alt="sort" /></div></div></th>
                                            <th><div className="th-data">Next Arrival <div className="sort-table"><img src={sortIcon} alt="sort" /></div></div></th>
                        ...
                        <Tab eventKey="recentDeparture" title="Recent Departure">
                            <div className="table-action-content">
                                <div className="_search-bar">
                                    <SearchBar placeHolder="Search" />
                                </div>
