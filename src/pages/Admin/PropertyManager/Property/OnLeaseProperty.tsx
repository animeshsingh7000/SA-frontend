...
import { getOnLeaseProperty } from "../../../../api/admin/property";
...
export default function OnLeaseProperty() {
    ...
    const fetchData = async (page:number, c?: number, quetyParams?:any) => {
        ...
        try {
            ...
            getOnLeaseProperty(payload).then((res) => {
                setLoader(false);
                setRowData(res.data);
    ...
    function navigateToCreate() {
        navigate(ROUTE_NAVIGATION_PATH.CREATE_PROPERTY + '/' + 3);
    }
    ...
    function exportData(e:any) {
        ...
        exportToXlsx(headers, keys, apiResponse, 'OnLease_Properties.xlsx');
    }
                                                ...
                                                {columns
                                                    ...
                                                    .map((col) => (
                                                        <td key={col.id}>
                                                            ...
                                                            {
                                                                col.id == 'propertyName' ?
                                                                    <Link to={ROUTE_NAVIGATION_PATH.UPDATE_PROPERTY + '/' + data._id + '/' + 3}>
                                                                        <div className="t-user">
                                                                            <div className="t-user-icon">
                                                                                <img src={buildingIcon} alt="icon" />
                                                                            </div>
