...
import { getActiveProperty } from "../../../../api/admin/property";
import { ACTIVE_PROPERTY_TABLE_COLUMNS } from "../../../../constants/Filters";
...
export default function ACtiveProperty() {
    ...
    const [columns, setColumns] = useState(ACTIVE_PROPERTY_TABLE_COLUMNS);
    ...
    const fetchData = async (page:number, c?: number, quetyParams?:any) => {
        ...
        try {
            ...
            getActiveProperty(payload).then((res) => {
                setLoader(false);
                setRowData(res.data);
    ...
    function navigateToCreate() {
        navigate(ROUTE_NAVIGATION_PATH.CREATE_PROPERTY + '/' + 1);
    }
    ...
    function exportData(e: any) {
        ...
        const visibleColumns = ACTIVE_PROPERTY_TABLE_COLUMNS.filter(col => col.visible);
        ...
        exportToXlsx(headers, keys, apiResponse, 'Listed_Properties.xlsx');
    }
    ...
    return (
        <>
            <div className="table-action-content">
                ...
                <div className="suggested-tab" style={{ 'display': 'none' }}>
                    <img src={homeIcon} alt="display" />  Suggested Property
                    <div className="drop-text-suggested scrollbar" >
                        <div className="hdtext">Daily Rate Limit (USD)</div>
                        <div className="_form_suggested">

                            <div className="col-6 _dollar">
                                {/* <FormControl
                                label="Min"
                        ...
                        <div className="suggested_btn_wrapper">
                            <button className="_button cancel">Cancel</button>
                            <button className="_button">Apply</button>
                        </div>
                    </div>
                </div>
                                            ...
                                            {columns
                                                ...
                                                .map((col) => (
                                                    <td key={col.id}>
                                                        ...
                                                        {
                                                            col.id == 'propertyName' ?
                                                                <Link to={ROUTE_NAVIGATION_PATH.UPDATE_PROPERTY + '/' + data._id + '/' + 1}>
                                                                    <div className="t-user">
                                                                        <div className="t-user-icon">
                                                                            <img src={buildingIcon} alt="icon" />
                                                                        </div>
