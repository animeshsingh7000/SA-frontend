...
import { getAllPropertyList } from "../../../../api/admin/property";
...
export default function AllProperty() {
    ...
    function navigateToCreate() {
        navigate(ROUTE_NAVIGATION_PATH.CREATE_PROPERTY + '/' + 0);
    }
    ...
    const fetchData = async (page:number, c?: number, quetyParams?:any) => {
        ...
        try {
            ...
            getAllPropertyList(payload).then((res) => {
                setLoader(false);
                setRowData(res.data);
    ...
    function exportData(e:any) {
        ...
        exportToXlsx(headers, keys, apiResponse, 'All_Properties.xlsx');
    }
    ...
    return (
        <>
            ...
            {/* <div className={`table-section-common ${initData.length > 0 ? 'when-filter-added' : '_owner-inquiry-table'}`}> */}
                                                ...
                                                {columns
                                                    ...
                                                    .map((col) => (
                                                        <td key={col.id}>
                                                            ...
                                                            {
                                                                col.id == 'propertyName' ?
                                                                    <Link to={ROUTE_NAVIGATION_PATH.UPDATE_PROPERTY + '/' + data._id + '/' + 0}>
