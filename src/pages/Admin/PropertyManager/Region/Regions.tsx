...
import { getRegionList } from "../../../../api/admin/regions";
...
export default function Regions() {
    ...
    function navigateToEdit(neighbourhoodId: any) {
        navigate(ROUTE_NAVIGATION_PATH.EDIT_REGION + '/' + neighbourhoodId);
    }
    ...
    function createRegions() {
        navigate(ROUTE_NAVIGATION_PATH.CREATE_REGION);
    }
    ...
    function exportData(e:any) {
        ...
        const headers = ['Regions', 'Description'];
        const keys = ['name', 'description'];

        const apiResponse = rowData;
    
        exportToXlsx(headers, keys, apiResponse, 'Regions.xlsx');
    }
            ...
            <div className="common-right-panel-section">
                ...
                <div className="mid-content-section pt-0">
                    ...
                    <div className="divshow">Show</div>
                        ...
                        <button className="btn primary" onClick={createRegions}>
                            <img src={plusWhite} alt="Icon" /> New Region
                        </button>
                    </div>
                    ...
                    <div className="table-section-common">
                        <Table responsive className="">
                            <thead>
                                <tr>
                                    <th>
                                        <div className="th-data firstchild">Regions 
