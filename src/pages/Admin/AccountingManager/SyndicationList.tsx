            ...
            <div className="common-right-panel-section">
                <div className="top-right-bar">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item href="#">iCal Feed Logs</Breadcrumb.Item>
                    </Breadcrumb>
                ...
                <div className="mid-content-section">
                    <Tabs
                        defaultActiveKey="FeedLogs"
                        id="fill-tab-example"
                        className="mb-3"
                        fill
                    >
                        <Tab eventKey="FeedLogs" title="iCal Feed Logs">
                                ...
                                <Table responsive className="">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><div className="th-data">Error Response <div className="sort-table"><img src={sortIcon} alt="sort" /></div></div></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>REMO - Remote ctrl malfunc</td>
                        ...
                        <Tab eventKey="RSSFeed" title="RSS Feed">
                            <div className="table-action-content">
                                <div className="_search-bar">
                                    <SearchBar placeHolder="Search" />
                                </div>
