...
export default function FutureLeaseList() {
    ...
    const fetchData = async (page:number, c?: number) => {
        ...
        try {
            const payload = {
                ...
                leaseType: LEASE_TYPE_FILTER.FUTURE
            }
    ...
    function exportData(e:any) {
        ...
        exportToXlsx(headers, keys, apiResponse, 'Future_Leases.xlsx');
    }
            ...
            <div className="common-right-panel-section">
                <div className="top-right-bar _bdr-none">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item active>Future Leases</Breadcrumb.Item>
                    </Breadcrumb>
                                                ...
                                                {columns
                                                    ...
                                                    .map((col) => (
                                                        <td key={col.id}>
                                                            ...
                                                            {
                                                                col.id == 'propertyName' ?
                                                                    <Link to={ROUTE_NAVIGATION_PATH.EDIT_LEASING + '/' + data._id + '/' + 4}>
