...
import { LEASE_TABLE_COLUMNS } from "../../../constants/Filters";
...
export default function CurrentFutureLeaseList() {
    ...
    const [columns, setColumns] = useState(LEASE_TABLE_COLUMNS);
    ...
    const fetchData = async (page:number, c?: number) => {
        ...
        try {
            const payload = {
                ...
                leaseType: LEASE_TYPE_FILTER.CURRENT_AND_FUTURE
            }
    ...
    function exportData(e:any) {
        ...
        const visibleColumns = LEASE_TABLE_COLUMNS.filter(col => col.visible);
        ...
        exportToXlsx(headers, keys, apiResponse, 'Current_Future_Leases.xlsx');
    }
            ...
            <div className="common-right-panel-section">
                <div className="top-right-bar _bdr-none">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item active>Current + Future Leases</Breadcrumb.Item>
                    </Breadcrumb>
                    <div className="heading">
                        <div className="guest-left">
                            <h1>Current + Future Leases</h1>
                        </div>
                    </div>
                                                ...
                                                {columns
                                                    ...
                                                    .map((col) => (
                                                        <td key={col.id}>
                                                            ...
                                                            {
                                                                col.id == 'propertyName' ?
                                                                    <Link to={ROUTE_NAVIGATION_PATH.EDIT_LEASING + '/' + data._id + '/' + 3}>
