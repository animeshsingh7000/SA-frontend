...
export default function CurrentPastLeaseList() {
    ...
    const fetchData = async (page:number, c?: number) => {
        ...
        try {
            const payload = {
                ...
                leaseType: LEASE_TYPE_FILTER.CURRENT_AND_PAST
            }
    ...
    function exportData(e:any) {
        ...
        exportToXlsx(headers, keys, apiResponse, 'Current_Past_Leases.xlsx');
    }
            ...
            <div className="common-right-panel-section">
                <div className="top-right-bar _bdr-none">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item active>Current + Past Leases</Breadcrumb.Item>
                    </Breadcrumb>
                    <div className="heading">
                        <div className="guest-left">
                            <h1>Current + Past Leases Leases</h1>
                        </div>
                    </div>
                                                ...
                                                {columns
                                                    ...
                                                    .map((col) => (
                                                        <td key={col.id}>
                                                            ...
                                                            {
                                                                col.id == 'propertyName' ?
                                                                    <Link to={ROUTE_NAVIGATION_PATH.EDIT_LEASING + '/' + data._id + '/' + 2}>
