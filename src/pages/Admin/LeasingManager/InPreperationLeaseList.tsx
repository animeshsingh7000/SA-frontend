...
export default function InPreperationLeaseList() {
    ...
    const fetchData = async (page:number, c?: number) => {
        ...
        try {
            const payload = {
                ...
                leaseType: LEASE_TYPE_FILTER.INPREPARATION
            }
    ...
    function exportData(e:any) {
        ...
        exportToXlsx(headers, keys, apiResponse, 'InPreparation_Leases.xlsx');
    }
            ...
            <div className="common-right-panel-section">
                <div className="top-right-bar _bdr-none">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item active>In Preperation Leases</Breadcrumb.Item>
                    </Breadcrumb>
                    <div className="heading">
                        <div className="guest-left">
                            <h1>In Preperation Leases</h1>
                        </div>
                    </div>
                                                ...
                                                {columns
                                                    ...
                                                    .map((col) => (
                                                        <td key={col.id}>
                                                            ...
                                                            {
                                                                col.id == 'propertyName' ?
                                                                    <Link to={ROUTE_NAVIGATION_PATH.EDIT_LEASING + '/' + data._id + '/' + 5}>
