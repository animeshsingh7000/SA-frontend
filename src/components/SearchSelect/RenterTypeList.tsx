...
import { getPerDiemType, getRenterType } from "../../api/admin/lease";
...
export default function RenterTypeList(props: FormControlProps) {
  ...
  useEffect(() => {
    if (!effectRan.current) {
      const fetchOptions = async () => {
        try {
          const response = await getRenterType();
